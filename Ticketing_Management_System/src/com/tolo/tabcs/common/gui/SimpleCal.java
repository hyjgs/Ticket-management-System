...
public class SimpleCal extends JDialog{
	...
	public SimpleCal(JFrame owner,JTextField text){
		super(owner,true);
		this.owner=owner;
		this.text=text;
...
//		yearSpi.getEditor().setEnabled(false);
	...
	public static void main(String[] args) {
		...
		j.setSize(200, 200);
		j.setVisible(true);
		SimpleCal c = new SimpleCal(j, new JTextField("日利"));
		c.setVisible(true);
	}
}
